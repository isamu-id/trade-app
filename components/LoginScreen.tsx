      ...
      <div className="w-full max-w-sm">
        ...
        >
          <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
            ...
            <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.6 16 19 13 24 13c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.7 6 29.6 4 24 4c-7.5 0-14 4.1-17.7 10.2z"/>
            <path fill="#4CAF50" d="M24 44c5.5 0 10.5-1.9 14.3-5.1l-6.6-5.4C29.6 35.4 26.9 36 24 36c-5.3 0-9.7-3.4-11.3-8l-6.6 5.1C9.9 39.8 16.4 44 24 44z"/>
            <path fill="#1976D2" d="M43.6 20.5H24v8h11.3c-.8 2.3-2.2 4.2-4 5.6l6.6 5.4C41.7 36.5 44 30.8 44 24c0-1.3-.1-2.7-.4-3.5z"/>
          </svg>
          Googleでログイン
        </button>
